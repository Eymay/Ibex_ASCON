...
CC = /home/eymen/Downloads/lowrisc-toolchain-rv32imcb-20230228-1/bin/riscv32-unknown-elf-gcc
CLANG = /home/eymen/Documents/Compiler/llvm-project/buildFullDebug/bin/clang --target=$(TARGET)
...
%.vmem: %.bin
	...
	srec_cat --fill 0x00 --within $@ --range-padding 4 -o $@ -vmem

%.bin: %.elf
	$(OBJCOPY) -O binary $^ $@

%.o: %.c
	$(CLANG) $(CFLAGS) -MMD -c $(INCS) -o $@ $<
